...
#[Route('/episode/c/r/u/d')]
class EpisodeCRUDController extends AbstractController
{
    #[Route('/', name: 'app_episode_c_r_u_d_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_episode_c_r_u_d_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_episode_c_r_u_d_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_episode_c_r_u_d_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_episode_c_r_u_d_delete', methods: ['POST'])]
